...
% parses up to three functions to your desired tex repository.
% INPUTS: 
%       up to three graphs defined by x and y
% OUTPUTS:
...
%
% DEPENDENCIES:
%       Dependent on matlab2tikz.m (google it) 
function graphtikz(xlab, ylab, titl, x, y, leg, x1, y1, leg1, x2, y2, leg2, x3, y3, leg3)
close all; 
  ...
  elseif nargin == 15
     ...
     plot(x,y,x1,y1,x2,y2,x3,y3,'linewidth',1.5); legend(sprintf('%s',leg),sprintf('%s',leg1),sprintf('%s',leg2),sprintf('%s',leg3));
      ...
      fprintf('===================================================\n\nYour input arguments are wrong, check "help graphtikz"\n\n==============================================================')
  end    
